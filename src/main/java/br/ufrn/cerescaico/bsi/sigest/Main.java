...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        EventoBO eventoMB = new EventoBO();
        eventoMB.inserir(evento);
        ...
        JRBeanCollectionDataSource data = new JRBeanCollectionDataSource(eventos);

        System.err.println("Filling time : " + (System.currentTimeMillis() - start));

        String jasperFile = System.getProperty("user.dir")+"/src/main/webapp/reports/listaEventos.jrxml";
